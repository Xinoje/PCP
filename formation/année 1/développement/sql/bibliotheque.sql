...
ALTER TABLE
    emprunt
ADD
    FOREIGN KEY (id_livre) REFERENCES bibliotheque.livre (id_livre);

ALTER TABLE
    emprunt
ADD
    FOREIGN KEY (id_abonne) REFERENCES bibliotheque.abonne (id_abonne);
...
VALUES
    ...
    (3, NULL, 3, '2014-12-19', '2014-12-22'),
